...
def evaluate_models_on_training(x, y, models):
    ...
    for model in models:
        ...
        rsqrd = r_squared(y, estimated)
        pylab.plot(x, y, 'bo', label = 'Measured points')
        pylab.plot(x, estimated, 'r', label = 'Estimated, R Squared = {}'.format(rsqrd))
        pylab.legend(loc = 'best')
        pylab.title('Regression of Temperature by Time')
        pylab.xlabel('Year')
